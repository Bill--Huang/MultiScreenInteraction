...
module.exports = {
    ...
    init: function() {
        ...
        self.utilities.cl('Server', 'Init Sockets Manager');
    },
    ...
    addAppSocket: function(socket) {
        ...
        if(!self.appSocket) {
                    ...
                    if(role == 'appgame') {
                        switch (message) {
                            case 'gameend_request':
                                ...
                                self.utilities.cl('Server', 'Get End Request From Server');
                                self.utilities.cl('Server', 'Winner: ' + payload['winIndex']);
            ...
            self.utilities.cl('Server', 'App have been register');
    ...
    addPlayerSocket: function(socket) {
        ...
        if(self.playerSockets[0] === null || self.playerSockets[1] === null) {
            ...
            self.utilities.cl('Server', 'Player ' + tempIndex + ' connect');
            ...
            self.utilities.cl('Server', 'Two Player have been register');
    ...
    removeAppSocket: function(socket) {
        var self = this;
        self.appSocket = null;
        self.utilities.cl('Server', 'App have been removed');
    },
    ...
    removePlayerSocket: function(socket) {
        ...
        self.utilities.cl('Server', 'Player ' + tempIndex + ' have been removed');
    },
    ...
    clean: function() {
        ...
        self.utilities.cl('Server', 'Reset Status');
    },
    ...
    checkGameStatus: function() {
        ...
        if(self.appSocket != null) {
            ...
            // meet demand
            self.utilities.cl('Server', 'Game Start');
